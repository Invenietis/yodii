#region LGPL License
/*----------------------------------------------------------------------------
* This file (ObjectExplorer\Yodii.ObjectExplorer.Wpf\Graph controls\YodiiGraphEdge.cs) is part of CiviKey. 
*  
...
{
    /// <summary>
    /// Edge between two vertices in the Yoddi.Live graph.
    /// </summary>
    public class YodiiGraphEdge : GraphX.EdgeBase<YodiiGraphVertex>, INotifyPropertyChanged
    {
        ...
        internal YodiiGraphEdge( YodiiGraphVertex source, YodiiGraphVertex target, IServiceReferenceInfo serviceRef )
        ...
        {
            if( e.PropertyName == "Requirement" ) ReferenceRequirement = (sender as IServiceReferenceInfo).Requirement;
        }
            ...
            get
            {
                ...
                else if( IsImplementation )
                {
                    return String.Format( "Implementation:\n\nPlugin {0} implements service {1}.",
                        Source.LivePluginInfo.PluginInfo.PluginFullName,
                        Target.LiveServiceInfo.ServiceInfo.ServiceFullName );
                }
                else
                {
