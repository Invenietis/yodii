...
namespace Yodii.Model
{
    ...
    public interface IYodiiEngineResult
    {
        ...
        /// <summary>
        /// Gets the details of errors encountered during resolution of configuration.
        ...
        /// <summary>
        /// Gets the details of errors encountered during static resolution.
        ...
        /// <summary>
        /// Gets the details of errors encountered during host startup and plugin startup/shutdown.
        ...
        /// <summary>
        /// Gets the list of plugins causing the failure, whatever the failure is (from  <see cref="StaticFailureResult"/> or <see cref="HostFailureResult"/>).
        /// Never null (but can be empty).
        /// </summary>
        IReadOnlyList<IPluginInfo> PluginCulprits { get; }
        
        /// <summary>
        /// Gets the list of services causing the failure: in case of <see cref="StaticFailureResult"/>, it is the service of <see cref="IStaticFailureResult.BlockingServices"/>
